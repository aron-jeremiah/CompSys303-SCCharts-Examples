...
void sendVariables(int send_interface) {
    ...
    // Send _g35_e1
    cJSON_AddItemToObject(root, "_g35_e1", cJSON_CreateBool(model._g35_e1));
    // Send _g38
    ...
    // Send _g40_e2
    cJSON_AddItemToObject(root, "_g40_e2", cJSON_CreateBool(model._g40_e2));
    // Send _g41
    ...
    // Send _g52_e1
    cJSON_AddItemToObject(root, "_g52_e1", cJSON_CreateBool(model._g52_e1));
    // Send _g54
    ...
    // Send _g59_e2
    cJSON_AddItemToObject(root, "_g59_e2", cJSON_CreateBool(model._g59_e2));
    // Send _g6
    ...
    // Send _g67_e3
    cJSON_AddItemToObject(root, "_g67_e3", cJSON_CreateBool(model._g67_e3));
    // Send _g68
    ...
    // Send _g76_e1
    cJSON_AddItemToObject(root, "_g76_e1", cJSON_CreateBool(model._g76_e1));
    // Send _g79
    ...
    // Send _pg14_e2
    cJSON_AddItemToObject(root, "_pg14_e2", cJSON_CreateBool(model._pg14_e2));
    // Send _pg27
    cJSON_AddItemToObject(root, "_pg27", cJSON_CreateBool(model._pg27));
    // Send _pg28
    cJSON_AddItemToObject(root, "_pg28", cJSON_CreateBool(model._pg28));
    // Send _pg31
    ...
    // Send _pg67_e3
    cJSON_AddItemToObject(root, "_pg67_e3", cJSON_CreateBool(model._pg67_e3));
    // Send _pg68
    cJSON_AddItemToObject(root, "_pg68", cJSON_CreateBool(model._pg68));
    // Send _pg69
    cJSON_AddItemToObject(root, "_pg69", cJSON_CreateBool(model._pg69));
    // Send _pg7
