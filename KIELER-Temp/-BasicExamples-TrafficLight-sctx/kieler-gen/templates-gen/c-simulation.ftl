...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}.sigG = item->valueint;
        }
        // Receive sigR
        item = cJSON_GetObjectItemCaseSensitive(root, "sigR");
        if(item != NULL) {
            ${tickdata_name}.sigR = item->valueint;
        }
        // Receive sigY
        item = cJSON_GetObjectItemCaseSensitive(root, "sigY");
        if(item != NULL) {
            ${tickdata_name}.sigY = item->valueint;
        }
        // Receive sleepT
        ...
        if(item != NULL) {
            ${tickdata_name}._cg69 = item->valueint;
        }
        // Receive _cg72
        ...
        if(item != NULL) {
            ${tickdata_name}._g22_e3 = item->valueint;
        }
        // Receive _g23
        ...
        if(item != NULL) {
            ${tickdata_name}._g27_e1 = item->valueint;
        }
        // Receive _g3
        ...
        if(item != NULL) {
            ${tickdata_name}._g32_e2 = item->valueint;
        }
        // Receive _g33
        ...
        if(item != NULL) {
            ${tickdata_name}._g40_e1 = item->valueint;
        }
        // Receive _g42
        ...
        if(item != NULL) {
            ${tickdata_name}._g55_e3 = item->valueint;
        }
        // Receive _g6
        ...
        if(item != NULL) {
            ${tickdata_name}._g61_e1 = item->valueint;
        }
        // Receive _g65
        ...
        if(item != NULL) {
            ${tickdata_name}._g68_e2 = item->valueint;
        }
        // Receive _g7
        ...
        if(item != NULL) {
            ${tickdata_name}._g76_e3 = item->valueint;
        }
        // Receive _g77
        ...
        if(item != NULL) {
            ${tickdata_name}._pg32_e2 = item->valueint;
        }
        // Receive _pg33
        ...
        if(item != NULL) {
            ${tickdata_name}.x = item->valuedouble;
        }
    }
...
void sendVariables(int send_interface) {
    ...
    // Send sigG
    cJSON_AddItemToObject(root, "sigG", cJSON_CreateBool(${tickdata_name}.sigG));
    // Send sigR
    cJSON_AddItemToObject(root, "sigR", cJSON_CreateBool(${tickdata_name}.sigR));
    // Send sigY
    cJSON_AddItemToObject(root, "sigY", cJSON_CreateBool(${tickdata_name}.sigY));
    // Send sleepT
    ...
    // Send _cg69
    cJSON_AddItemToObject(root, "_cg69", cJSON_CreateBool(${tickdata_name}._cg69));
    // Send _cg72
    ...
    // Send _g22_e3
    cJSON_AddItemToObject(root, "_g22_e3", cJSON_CreateBool(${tickdata_name}._g22_e3));
    // Send _g23
    ...
    // Send _g27_e1
    cJSON_AddItemToObject(root, "_g27_e1", cJSON_CreateBool(${tickdata_name}._g27_e1));
    // Send _g3
    ...
    // Send _g32_e2
    cJSON_AddItemToObject(root, "_g32_e2", cJSON_CreateBool(${tickdata_name}._g32_e2));
    // Send _g33
    ...
    // Send _g40_e1
    cJSON_AddItemToObject(root, "_g40_e1", cJSON_CreateBool(${tickdata_name}._g40_e1));
    // Send _g42
    ...
    // Send _g55_e3
    cJSON_AddItemToObject(root, "_g55_e3", cJSON_CreateBool(${tickdata_name}._g55_e3));
    // Send _g6
    ...
    // Send _g61_e1
    cJSON_AddItemToObject(root, "_g61_e1", cJSON_CreateBool(${tickdata_name}._g61_e1));
    // Send _g65
    ...
    // Send _g68_e2
    cJSON_AddItemToObject(root, "_g68_e2", cJSON_CreateBool(${tickdata_name}._g68_e2));
    // Send _g7
    ...
    // Send _g76_e3
    cJSON_AddItemToObject(root, "_g76_e3", cJSON_CreateBool(${tickdata_name}._g76_e3));
    // Send _g77
    ...
    // Send _pg32_e2
    cJSON_AddItemToObject(root, "_pg32_e2", cJSON_CreateBool(${tickdata_name}._pg32_e2));
    // Send _pg33
    ...
    // Send x
    cJSON_AddItemToObject(root, "x", cJSON_CreateNumber(${tickdata_name}.x));
