...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        // Receive R1
        item = cJSON_GetObjectItemCaseSensitive(root, "R1");
        if(item != NULL) {
            ${tickdata_name}.R1 = item->valueint;
        }
        // Receive O
        ...
        // Receive _ABRO_local__Atrig
        item = cJSON_GetObjectItemCaseSensitive(root, "_ABRO_local__Atrig");
        if(item != NULL) {
            ${tickdata_name}._ABRO_local__Atrig = item->valueint;
        }
        // Receive _ABRO_local__Atrig1
        item = cJSON_GetObjectItemCaseSensitive(root, "_ABRO_local__Atrig1");
        if(item != NULL) {
            ${tickdata_name}._ABRO_local__Atrig1 = item->valueint;
        }
        // Receive _ABRO_local__Tterm
        item = cJSON_GetObjectItemCaseSensitive(root, "_ABRO_local__Tterm");
        if(item != NULL) {
            ${tickdata_name}._ABRO_local__Tterm = item->valueint;
        }
        // Receive _ABRO_local__Tterm1
        item = cJSON_GetObjectItemCaseSensitive(root, "_ABRO_local__Tterm1");
        if(item != NULL) {
            ${tickdata_name}._ABRO_local__Tterm1 = item->valueint;
        }
        // Receive _GO
        ...
        // Receive _g19_e3
        item = cJSON_GetObjectItemCaseSensitive(root, "_g19_e3");
        if(item != NULL) {
            ${tickdata_name}._g19_e3 = item->valueint;
        }
        // Receive _g20
        ...
        // Receive _g24_e1
        item = cJSON_GetObjectItemCaseSensitive(root, "_g24_e1");
        if(item != NULL) {
            ${tickdata_name}._g24_e1 = item->valueint;
        }
        // Receive _g27
        ...
        // Receive _g28_e2
        item = cJSON_GetObjectItemCaseSensitive(root, "_g28_e2");
        if(item != NULL) {
            ${tickdata_name}._g28_e2 = item->valueint;
        }
        // Receive _g6
        ...
        // Receive _g8_e1
        item = cJSON_GetObjectItemCaseSensitive(root, "_g8_e1");
        if(item != NULL) {
            ${tickdata_name}._g8_e1 = item->valueint;
        }
        // Receive _pg14
        ...
        // Receive _pg28_e2
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg28_e2");
        if(item != NULL) {
            ${tickdata_name}._pg28_e2 = item->valueint;
        }
...
void sendVariables(int send_interface) {
    ...
    // Send R1
    cJSON_AddItemToObject(root, "R1", cJSON_CreateBool(${tickdata_name}.R1));
    // Send O
    ...
    // Send _ABRO_local__Atrig
    cJSON_AddItemToObject(root, "_ABRO_local__Atrig", cJSON_CreateBool(${tickdata_name}._ABRO_local__Atrig));
    // Send _ABRO_local__Atrig1
    cJSON_AddItemToObject(root, "_ABRO_local__Atrig1", cJSON_CreateBool(${tickdata_name}._ABRO_local__Atrig1));
    // Send _ABRO_local__Tterm
    cJSON_AddItemToObject(root, "_ABRO_local__Tterm", cJSON_CreateBool(${tickdata_name}._ABRO_local__Tterm));
    // Send _ABRO_local__Tterm1
    cJSON_AddItemToObject(root, "_ABRO_local__Tterm1", cJSON_CreateBool(${tickdata_name}._ABRO_local__Tterm1));
    // Send _GO
    ...
    // Send _g19_e3
    cJSON_AddItemToObject(root, "_g19_e3", cJSON_CreateBool(${tickdata_name}._g19_e3));
    // Send _g20
    ...
    // Send _g24_e1
    cJSON_AddItemToObject(root, "_g24_e1", cJSON_CreateBool(${tickdata_name}._g24_e1));
    // Send _g27
    ...
    // Send _g28_e2
    cJSON_AddItemToObject(root, "_g28_e2", cJSON_CreateBool(${tickdata_name}._g28_e2));
    // Send _g6
    ...
    // Send _g8_e1
    cJSON_AddItemToObject(root, "_g8_e1", cJSON_CreateBool(${tickdata_name}._g8_e1));
    // Send _pg14
    ...
    // Send _pg28_e2
    cJSON_AddItemToObject(root, "_pg28_e2", cJSON_CreateBool(${tickdata_name}._pg28_e2));
    ...
    if (send_interface) {
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "R1", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_ABRO_local__Atrig", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("sccharts-generated"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_ABRO_local__Atrig1", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("sccharts-generated"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_ABRO_local__Tterm", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("sccharts-generated"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_ABRO_local__Tterm1", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_g19_e3", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("guard"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_g24_e1", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("guard"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_g28_e2", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("guard"));
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_g8_e1", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        ...
        cJSON_AddItemToObject(info, "type", cJSON_CreateString("bool"));
        cJSON_AddItemToObject(info, "properties", properties);
        cJSON_AddItemToObject(interface, "_pg28_e2", info);
        info = cJSON_CreateObject();
        properties = cJSON_CreateArray();
        cJSON_AddItemToArray(properties, cJSON_CreateString("sccharts-generated"));
