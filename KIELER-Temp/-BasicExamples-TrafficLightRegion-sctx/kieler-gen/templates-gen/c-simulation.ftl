...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}._TrafficLight_local__Atrig9 = item->valueint;
        }
        ...
        if(item != NULL) {
            ${tickdata_name}._g131_e2 = item->valueint;
        }
        // Receive _g137
        ...
        if(item != NULL) {
            ${tickdata_name}._g144_e2 = item->valueint;
        }
        // Receive _g147
        ...
        if(item != NULL) {
            ${tickdata_name}._g153_e3 = item->valueint;
        }
        // Receive _g154
        ...
        if(item != NULL) {
            ${tickdata_name}._g32_e1 = item->valueint;
        }
        // Receive _g35
        ...
        if(item != NULL) {
            ${tickdata_name}._g36_e2 = item->valueint;
        }
        // Receive _g37
        ...
        if(item != NULL) {
            ${tickdata_name}._g44_e1 = item->valueint;
        }
        // Receive _g47
        ...
        if(item != NULL) {
            ${tickdata_name}._g48_e2 = item->valueint;
        }
        // Receive _g49
        ...
        if(item != NULL) {
            ${tickdata_name}._g72_e3 = item->valueint;
        }
        // Receive _g73
        ...
        if(item != NULL) {
            ${tickdata_name}._g81_e4 = item->valueint;
        }
        // Receive _g82
        ...
        if(item != NULL) {
            ${tickdata_name}._pg123 = item->valueint;
        }
        // Receive _pg127
        ...
        if(item != NULL) {
            ${tickdata_name}._pg127_e1 = item->valueint;
        }
        // Receive _pg13
        ...
        if(item != NULL) {
            ${tickdata_name}._pg48_e2 = item->valueint;
        }
        // Receive _pg50
...
void sendVariables(int send_interface) {
    ...
    cJSON_AddItemToObject(root, "_TrafficLight_local__Atrig10", cJSON_CreateBool(${tickdata_name}._TrafficLight_local__Atrig10));
    // Send _TrafficLight_local__Atrig11
    cJSON_AddItemToObject(root, "_TrafficLight_local__Atrig11", cJSON_CreateBool(${tickdata_name}._TrafficLight_local__Atrig11));
    // Send _TrafficLight_local__Atrig12
    cJSON_AddItemToObject(root, "_TrafficLight_local__Atrig12", cJSON_CreateBool(${tickdata_name}._TrafficLight_local__Atrig12));
    ...
    cJSON_AddItemToObject(root, "_TrafficLight_local__Atrig9", cJSON_CreateBool(${tickdata_name}._TrafficLight_local__Atrig9));
    ...
    // Send _g131_e2
    cJSON_AddItemToObject(root, "_g131_e2", cJSON_CreateBool(${tickdata_name}._g131_e2));
    // Send _g137
    ...
    // Send _g144_e2
    cJSON_AddItemToObject(root, "_g144_e2", cJSON_CreateBool(${tickdata_name}._g144_e2));
    // Send _g147
    ...
    // Send _g153_e3
    cJSON_AddItemToObject(root, "_g153_e3", cJSON_CreateBool(${tickdata_name}._g153_e3));
    // Send _g154
    ...
    // Send _g32_e1
    cJSON_AddItemToObject(root, "_g32_e1", cJSON_CreateBool(${tickdata_name}._g32_e1));
    // Send _g35
    ...
    // Send _g36_e2
    cJSON_AddItemToObject(root, "_g36_e2", cJSON_CreateBool(${tickdata_name}._g36_e2));
    // Send _g37
    ...
    // Send _g44_e1
    cJSON_AddItemToObject(root, "_g44_e1", cJSON_CreateBool(${tickdata_name}._g44_e1));
    // Send _g47
    ...
    // Send _g48_e2
    cJSON_AddItemToObject(root, "_g48_e2", cJSON_CreateBool(${tickdata_name}._g48_e2));
    // Send _g49
    ...
    // Send _g72_e3
    cJSON_AddItemToObject(root, "_g72_e3", cJSON_CreateBool(${tickdata_name}._g72_e3));
    // Send _g73
    ...
    // Send _g81_e4
    cJSON_AddItemToObject(root, "_g81_e4", cJSON_CreateBool(${tickdata_name}._g81_e4));
    // Send _g82
    ...
    // Send _pg123
    cJSON_AddItemToObject(root, "_pg123", cJSON_CreateBool(${tickdata_name}._pg123));
    // Send _pg127
    cJSON_AddItemToObject(root, "_pg127", cJSON_CreateBool(${tickdata_name}._pg127));
    // Send _pg127_e1
    cJSON_AddItemToObject(root, "_pg127_e1", cJSON_CreateBool(${tickdata_name}._pg127_e1));
    // Send _pg13
    ...
    // Send _pg48_e2
    cJSON_AddItemToObject(root, "_pg48_e2", cJSON_CreateBool(${tickdata_name}._pg48_e2));
    // Send _pg50
